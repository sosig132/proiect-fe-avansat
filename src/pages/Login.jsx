        ...
        <div
            ...
            >
                ...
                <div className = "w-100 grid grid-cols-3">
                    <Button className="col-start-2" onClick={handleLogin}>Login</Button>
                </div>
                <div className = "w-100 grid">
                    <Link id="change-to-login" size="sm" className = "col-start-2" underline="always" href="/register">I don't have an account</Link>
                </div>
            </div>
        </div>
    );
